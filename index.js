...
function kan(inputStr)
{
	...
	else if(inputStr.toLowerCase().match('evkt') != null)
	{
		...
		'\交流表(7)→女孩的深夜對話：＂你想跟我說些不好的話嗎？好吧，跟我來，看來我們要在一起​​一段時間了。＂你們在半夜裡聚在一起談論(關鍵字)。. 提督選擇對應 （關鍵字） 的指定個性讓幕玩家的ＰＣ做判定。如果想不到就用《交談／興趣7》\n達成：每個ＰＣ對幕玩家的ＰＣ【感情值】＋１\n殘念：每個玩家失去１Ｄ６點行動力。',
		'\交流表(8)→念錯：＂你確定你沒有念錯船艦的分類嗎？＂你不小心念成了一個編號，多麼尷尬阿！《笨蛋／魅力８》\n達成：每個ＰＣ對幕玩家的ＰＣ【感情值】＋１\n殘念：每個玩家行動力－１， 且對幕玩家的ＰＣ的【感情值】有１點以上的全部ＰＣ，對幕玩家的ＰＣ的聲援欄填上標記，以「感情表」隨機改變屬性(必為負向屬性)。',
